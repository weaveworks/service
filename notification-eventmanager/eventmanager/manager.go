...
func New(usersClient users.UsersClient, db db.DB, sqsClient sqsiface.SQSAPI, sqsQueue, wcURL string, templates userTemplates.Engine) *EventManager {
	return &EventManager{
		...
		SQSQueue:    sqsQueue,
		WcURL:       wcURL,
		Render:      render.NewRender(templates),
