...
func requestOrgAs(t *testing.T, user *user, method string, org string, email string, body io.Reader, expectedStatus int) map[string]interface{} {
...
func requestInvite(t *testing.T, user *user, org *organization, email string, expectedStatus int) map[string]interface{} {
