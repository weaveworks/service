...
type DB interface {
	...
	InviteUser(ctx context.Context, email, orgExternalID string, role string) (*users.User, bool, error)
	...
	AddUserToTeam(_ context.Context, userID, teamID string, role string) error
