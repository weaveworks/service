...
type DataRetention struct {
	ID                string `protobuf:"bytes,1,opt,name=ID,proto3" json:"ID,omitempty"`
	DataRetentionDays int32  `protobuf:"varint,2,opt,name=DataRetentionDays,proto3" json:"DataRetentionDays,omitempty"`
}

func (m *DataRetention) Reset()                    { *m = DataRetention{} }
func (*DataRetention) ProtoMessage()               {}
func (*DataRetention) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{34} }

func (m *DataRetention) GetID() string {
	if m != nil {
		return m.ID
	}
	return ""
...
func (m *DataRetention) GetDataRetentionDays() int32 {
	if m != nil {
...
func (*User) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{35} }
...
func (*NotifyTrialExpiredRequest) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{38} }
...
func (*NotifyTrialExpiredResponse) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{39} }
...
type Team struct {
	...
	DeletedAt                    *time.Time `protobuf:"bytes,10,opt,name=DeletedAt,stdtime" json:"-"`
}

func (m *Team) Reset()                    { *m = Team{} }
func (*Team) ProtoMessage()               {}
func (*Team) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{42} }
...
func (*Empty) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{43} }
...
func (*Summary) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{44} }
...
func (*SummaryEntry) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{45} }
...
func (*Webhook) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{46} }
...
func (*Permission) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{52} }
...
func (*Role) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{53} }
...
func (*RequireOrgMemberPermissionToRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{55}
}
...
func init() {
	...
	proto.RegisterType((*DataRetention)(nil), "users.DataRetention")
...
func (this *DataRetention) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*DataRetention)
	if !ok {
		that2, ok := that.(DataRetention)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.DataRetentionDays != that1.DataRetentionDays {
		return false
	}
	return true
}
...
func (this *DataRetention) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&users.DataRetention{")
	s = append(s, "ID: "+fmt.Sprintf("%#v", this.ID)+",\n")
	s = append(s, "DataRetentionDays: "+fmt.Sprintf("%#v", this.DataRetentionDays)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type UsersClient interface {
	...
	GetDataRetention(ctx context.Context, in *GetOrganizationRequest, opts ...grpc.CallOption) (*DataRetention, error)
}
...
func (c *usersClient) GetDataRetention(ctx context.Context, in *GetOrganizationRequest, opts ...grpc.CallOption) (*DataRetention, error) {
	out := new(DataRetention)
	err := grpc.Invoke(ctx, "/users.Users/GetDataRetention", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	GetDataRetention(context.Context, *GetOrganizationRequest) (*DataRetention, error)
}
...
func _Users_GetDataRetention_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrganizationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).GetDataRetention(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.Users/GetDataRetention",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).GetDataRetention(ctx, req.(*GetOrganizationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Users_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Users_GetDataRetention_Handler,
		},
	},
...
func (m *DataRetention) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataRetention) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.DataRetentionDays != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintUsers(dAtA, i, uint64(m.DataRetentionDays))
	}
	return i, nil
}
...
func (m *Team) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DeletedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt)))
		n35, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *SummaryEntry) MarshalTo(dAtA []byte) (int, error) {
	...
	n36, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.OrgCreatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n36
	if m.FirstSeenConnectedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.FirstSeenConnectedAt)))
		n37, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.FirstSeenConnectedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	i++
	i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.TrialExpiresAt)))
	n38, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.TrialExpiresAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n38
	if m.TrialPendingExpiryNotifiedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.TrialPendingExpiryNotifiedAt)))
		n39, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.TrialPendingExpiryNotifiedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
	...
	if m.TrialExpiredNotifiedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.TrialExpiredNotifiedAt)))
		n40, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.TrialExpiredNotifiedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if m.ZuoraAccountCreatedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.ZuoraAccountCreatedAt)))
		n41, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ZuoraAccountCreatedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	n42, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.GCPAccountCreatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func (m *Webhook) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.CreatedAt)))
	n43, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.CreatedAt, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n43
	if m.DeletedAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.DeletedAt)))
		n44, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.DeletedAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.FirstSeenAt != nil {
		...
		n45, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.FirstSeenAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *LookupOrganizationWebhookUsingSecretIDResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Webhook != nil {
		...
		n46, err := m.Webhook.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *SetOrganizationWebhookFirstSeenAtResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.FirstSeenAt != nil {
		...
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.FirstSeenAt)))
		n47, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.FirstSeenAt, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *RequireTeamMemberPermissionToRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TeamID != nil {
		nn48, err := m.TeamID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn48
...
func (m *RequireOrgMemberPermissionToRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OrgID != nil {
		nn49, err := m.OrgID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn49
...
func NewPopulatedDataRetention(r randyUsers, easy bool) *DataRetention {
	this := &DataRetention{}
	this.ID = string(randStringUsers(r))
	this.DataRetentionDays = int32(r.Int31())
	if r.Intn(2) == 0 {
...
func (m *DataRetention) Size() (n int) {
	var l int
	_ = l
	l = len(m.ID)
	if l > 0 {
	...
	if m.DataRetentionDays != 0 {
		n += 1 + sovUsers(uint64(m.DataRetentionDays))
	}
	return n
}
...
func (this *DataRetention) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DataRetention{`,
		`ID:` + fmt.Sprintf("%v", this.ID) + `,`,
		`DataRetentionDays:` + fmt.Sprintf("%v", this.DataRetentionDays) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *DataRetention) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DataRetention: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DataRetention: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DataRetentionDays |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorUsers = []byte{
	...
	,
}
