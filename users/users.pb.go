...
type AuthServiceClient interface {
	// AuthUser authenticates a cookie for validity.
	AuthUser(ctx context.Context, in *LookupUserRequest, opts ...grpc.CallOption) (*LookupUserResponse, error)
	// AuthUserOrgRequest authenticates & authorizes a cookie for access to an org by extenal ID.
	AuthUserForOrg(ctx context.Context, in *LookupOrgRequest, opts ...grpc.CallOption) (*LookupOrgResponse, error)
	// AuthTokenForOrg authenticates & authorizes a token for access to an org.
	AuthTokenForOrg(ctx context.Context, in *LookupUsingTokenRequest, opts ...grpc.CallOption) (*LookupUsingTokenResponse, error)
	// AuthWebhookSecretForOrg returns a Webhook given the external org ID and the webhook secret ID
	AuthWebhookSecretForOrg(ctx context.Context, in *LookupOrganizationWebhookUsingSecretIDRequest, opts ...grpc.CallOption) (*LookupOrganizationWebhookUsingSecretIDResponse, error)
	// AuthUserForAdmin authenticates & authorizes a cookie for weave cloud admin access.
	AuthUserForAdmin(ctx context.Context, in *LookupAdminRequest, opts ...grpc.CallOption) (*LookupAdminResponse, error)
}
...
func (c *authServiceClient) AuthUser(ctx context.Context, in *LookupUserRequest, opts ...grpc.CallOption) (*LookupUserResponse, error) {
	out := new(LookupUserResponse)
	err := grpc.Invoke(ctx, "/users.AuthService/AuthUser", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthUserForOrg(ctx context.Context, in *LookupOrgRequest, opts ...grpc.CallOption) (*LookupOrgResponse, error) {
	out := new(LookupOrgResponse)
	err := grpc.Invoke(ctx, "/users.AuthService/AuthUserForOrg", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthTokenForOrg(ctx context.Context, in *LookupUsingTokenRequest, opts ...grpc.CallOption) (*LookupUsingTokenResponse, error) {
	out := new(LookupUsingTokenResponse)
	err := grpc.Invoke(ctx, "/users.AuthService/AuthTokenForOrg", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthWebhookSecretForOrg(ctx context.Context, in *LookupOrganizationWebhookUsingSecretIDRequest, opts ...grpc.CallOption) (*LookupOrganizationWebhookUsingSecretIDResponse, error) {
	out := new(LookupOrganizationWebhookUsingSecretIDResponse)
	err := grpc.Invoke(ctx, "/users.AuthService/AuthWebhookSecretForOrg", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) AuthUserForAdmin(ctx context.Context, in *LookupAdminRequest, opts ...grpc.CallOption) (*LookupAdminResponse, error) {
	out := new(LookupAdminResponse)
	err := grpc.Invoke(ctx, "/users.AuthService/AuthUserForAdmin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	// AuthUser authenticates a cookie for validity.
	AuthUser(context.Context, *LookupUserRequest) (*LookupUserResponse, error)
	// AuthUserOrgRequest authenticates & authorizes a cookie for access to an org by extenal ID.
	AuthUserForOrg(context.Context, *LookupOrgRequest) (*LookupOrgResponse, error)
	// AuthTokenForOrg authenticates & authorizes a token for access to an org.
	AuthTokenForOrg(context.Context, *LookupUsingTokenRequest) (*LookupUsingTokenResponse, error)
	// AuthWebhookSecretForOrg returns a Webhook given the external org ID and the webhook secret ID
	AuthWebhookSecretForOrg(context.Context, *LookupOrganizationWebhookUsingSecretIDRequest) (*LookupOrganizationWebhookUsingSecretIDResponse, error)
	// AuthUserForAdmin authenticates & authorizes a cookie for weave cloud admin access.
	AuthUserForAdmin(context.Context, *LookupAdminRequest) (*LookupAdminResponse, error)
}
...
func _AuthService_AuthUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.AuthService/AuthUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthUser(ctx, req.(*LookupUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_AuthUserForOrg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupOrgRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthUserForOrg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.AuthService/AuthUserForOrg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthUserForOrg(ctx, req.(*LookupOrgRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_AuthTokenForOrg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupUsingTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthTokenForOrg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.AuthService/AuthTokenForOrg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthTokenForOrg(ctx, req.(*LookupUsingTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_AuthWebhookSecretForOrg_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupOrganizationWebhookUsingSecretIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthWebhookSecretForOrg(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.AuthService/AuthWebhookSecretForOrg",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthWebhookSecretForOrg(ctx, req.(*LookupOrganizationWebhookUsingSecretIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_AuthUserForAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LookupAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).AuthUserForAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.AuthService/AuthUserForAdmin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AuthUserForAdmin(ctx, req.(*LookupAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _AuthService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AuthUserForOrg",
			Handler:    _AuthService_AuthUserForOrg_Handler,
		},
		{
		...
		{
			MethodName: "AuthWebhookSecretForOrg",
			Handler:    _AuthService_AuthWebhookSecretForOrg_Handler,
		},
		{
			MethodName: "AuthUserForAdmin",
...
var fileDescriptorUsers = []byte{
	...
	,
}
