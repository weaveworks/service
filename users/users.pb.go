...
/*
	...
	It has these top-level messages:
		...
		Permission
		Role
		RequireTeamMemberPermissionToRequest
		RequireOrgMemberPermissionToRequest
		DataExpiryRequest
		DataExpiryResponse
*/
package users
...
func (*GetOrganizationsReadyForWeeklyReportRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{30}
}
...
func (*SendOutWeeklyReportRequest) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{32} }
...
func (*User) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{34} }
...
func (*NotifyTrialExpiredRequest) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{37} }
...
func (*NotifyTrialExpiredResponse) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{38} }
...
func (*NotifyRefuseDataUploadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{39}
}
...
func (*NotifyRefuseDataUploadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{40}
}
...
func (*Team) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{41} }
...
func (*Empty) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{42} }
...
func (*Summary) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{43} }
...
func (*SummaryEntry) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{44} }
...
func (*Webhook) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{45} }
...
func (*LookupOrganizationWebhookUsingSecretIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{46}
}
...
func (*LookupOrganizationWebhookUsingSecretIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{47}
}
...
func (*Permission) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{51} }
...
func (*Role) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{52} }
...
func (*RequireTeamMemberPermissionToRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{53}
}
...
type RequireTeamMemberPermissionToRequest_TeamExternalID struct {
	TeamExternalID string `protobuf:"bytes,2,opt,name=TeamExternalID,proto3,oneof"`
}
type RequireTeamMemberPermissionToRequest_TeamInternalID struct {
	TeamInternalID string `protobuf:"bytes,4,opt,name=TeamInternalID,proto3,oneof"`
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*RequireTeamMemberPermissionToRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RequireTeamMemberPermissionToRequest_OneofMarshaler, _RequireTeamMemberPermissionToRequest_OneofUnmarshaler, _RequireTeamMemberPermissionToRequest_OneofSizer, []interface{}{
		(*RequireTeamMemberPermissionToRequest_TeamExternalID)(nil),
		(*RequireTeamMemberPermissionToRequest_TeamInternalID)(nil),
	}
}

func _RequireTeamMemberPermissionToRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*RequireTeamMemberPermissionToRequest)
	// TeamID
	switch x := m.TeamID.(type) {
	case *RequireTeamMemberPermissionToRequest_TeamExternalID:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.TeamExternalID)
	case *RequireTeamMemberPermissionToRequest_TeamInternalID:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.TeamInternalID)
	case nil:
	default:
		return fmt.Errorf("RequireTeamMemberPermissionToRequest.TeamID has unexpected type %T", x)
	}
	return nil
}

func _RequireTeamMemberPermissionToRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RequireTeamMemberPermissionToRequest)
	switch tag {
	case 2: // TeamID.TeamExternalID
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.TeamID = &RequireTeamMemberPermissionToRequest_TeamExternalID{x}
		return true, err
	case 4: // TeamID.TeamInternalID
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.TeamID = &RequireTeamMemberPermissionToRequest_TeamInternalID{x}
		return true, err
	default:
		return false, nil
	}
...
func _RequireTeamMemberPermissionToRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*RequireTeamMemberPermissionToRequest)
	// TeamID
	switch x := m.TeamID.(type) {
	case *RequireTeamMemberPermissionToRequest_TeamExternalID:
		n += proto.SizeVarint(2<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.TeamExternalID)))
		n += len(x.TeamExternalID)
	case *RequireTeamMemberPermissionToRequest_TeamInternalID:
		n += proto.SizeVarint(4<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.TeamInternalID)))
		n += len(x.TeamInternalID)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
func (*RequireOrgMemberPermissionToRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorUsers, []int{54}
}
...
type RequireOrgMemberPermissionToRequest_OrgExternalID struct {
	OrgExternalID string `protobuf:"bytes,2,opt,name=OrgExternalID,proto3,oneof"`
}
type RequireOrgMemberPermissionToRequest_OrgInternalID struct {
	OrgInternalID string `protobuf:"bytes,4,opt,name=OrgInternalID,proto3,oneof"`
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*RequireOrgMemberPermissionToRequest) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _RequireOrgMemberPermissionToRequest_OneofMarshaler, _RequireOrgMemberPermissionToRequest_OneofUnmarshaler, _RequireOrgMemberPermissionToRequest_OneofSizer, []interface{}{
		(*RequireOrgMemberPermissionToRequest_OrgExternalID)(nil),
		(*RequireOrgMemberPermissionToRequest_OrgInternalID)(nil),
	}
}

func _RequireOrgMemberPermissionToRequest_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*RequireOrgMemberPermissionToRequest)
	// OrgID
	switch x := m.OrgID.(type) {
	case *RequireOrgMemberPermissionToRequest_OrgExternalID:
		_ = b.EncodeVarint(2<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.OrgExternalID)
	case *RequireOrgMemberPermissionToRequest_OrgInternalID:
		_ = b.EncodeVarint(4<<3 | proto.WireBytes)
		_ = b.EncodeStringBytes(x.OrgInternalID)
	case nil:
	default:
		return fmt.Errorf("RequireOrgMemberPermissionToRequest.OrgID has unexpected type %T", x)
	}
	return nil
}

func _RequireOrgMemberPermissionToRequest_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*RequireOrgMemberPermissionToRequest)
	switch tag {
	case 2: // OrgID.OrgExternalID
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.OrgID = &RequireOrgMemberPermissionToRequest_OrgExternalID{x}
		return true, err
	case 4: // OrgID.OrgInternalID
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.OrgID = &RequireOrgMemberPermissionToRequest_OrgInternalID{x}
		return true, err
	default:
		return false, nil
	}
...
func _RequireOrgMemberPermissionToRequest_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*RequireOrgMemberPermissionToRequest)
	// OrgID
	switch x := m.OrgID.(type) {
	case *RequireOrgMemberPermissionToRequest_OrgExternalID:
		n += proto.SizeVarint(2<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.OrgExternalID)))
		n += len(x.OrgExternalID)
	case *RequireOrgMemberPermissionToRequest_OrgInternalID:
		n += proto.SizeVarint(4<<3 | proto.WireBytes)
		n += proto.SizeVarint(uint64(len(x.OrgInternalID)))
		n += len(x.OrgInternalID)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
type DataExpiryRequest struct {
	// If org supplied, answer when it expires
	OrganizationID string `protobuf:"bytes,1,opt,name=OrganizationID,proto3" json:"organizationID,omitempty"`
	// If timestamps supplied, answer which orgs should be deleted
	From time.Time `protobuf:"bytes,2,opt,name=From,stdtime" json:"From"`
	To   time.Time `protobuf:"bytes,3,opt,name=To,stdtime" json:"To"`
}

func (m *DataExpiryRequest) Reset()                    { *m = DataExpiryRequest{} }
func (*DataExpiryRequest) ProtoMessage()               {}
func (*DataExpiryRequest) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{55} }

func (m *DataExpiryRequest) GetOrganizationID() string {
	if m != nil {
		return m.OrganizationID
	}
	return ""
...
func (m *DataExpiryRequest) GetFrom() time.Time {
	if m != nil {
		return m.From
	}
	return time.Time{}
...
func (m *DataExpiryRequest) GetTo() time.Time {
	if m != nil {
		return m.To
	}
	return time.Time{}
...
type DataExpiryResponse struct {
	// It's OK to delete all data before this date.
	ExpireBefore *time.Time `protobuf:"bytes,1,opt,name=ExpireBefore,stdtime" json:"ExpireBefore,omitempty"`
	// All of these organizations should be deleted
	OrganizationID []string `protobuf:"bytes,2,rep,name=OrganizationID" json:"OrganizationID,omitempty"`
}

func (m *DataExpiryResponse) Reset()                    { *m = DataExpiryResponse{} }
func (*DataExpiryResponse) ProtoMessage()               {}
func (*DataExpiryResponse) Descriptor() ([]byte, []int) { return fileDescriptorUsers, []int{56} }

func (m *DataExpiryResponse) GetExpireBefore() *time.Time {
	if m != nil {
		return m.ExpireBefore
	}
	return nil
}

func (m *DataExpiryResponse) GetOrganizationID() []string {
	if m != nil {
		return m.OrganizationID
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*DataExpiryRequest)(nil), "users.DataExpiryRequest")
	proto.RegisterType((*DataExpiryResponse)(nil), "users.DataExpiryResponse")
...
func (this *DataExpiryRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*DataExpiryRequest)
	if !ok {
		that2, ok := that.(DataExpiryRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *DataExpiryResponse) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
	...
	that1, ok := that.(*DataExpiryResponse)
	if !ok {
		that2, ok := that.(DataExpiryResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if that1.ExpireBefore == nil {
		if this.ExpireBefore != nil {
			return false
		}
	} else if !this.ExpireBefore.Equal(*that1.ExpireBefore) {
		return false
	}
	if len(this.OrganizationID) != len(that1.OrganizationID) {
		return false
	}
	for i := range this.OrganizationID {
		if this.OrganizationID[i] != that1.OrganizationID[i] {
			return false
		}
	}
	return true
...
func (this *DataExpiryRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&users.DataExpiryRequest{")
	s = append(s, "OrganizationID: "+fmt.Sprintf("%#v", this.OrganizationID)+",\n")
...
func (this *DataExpiryResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&users.DataExpiryResponse{")
	s = append(s, "ExpireBefore: "+fmt.Sprintf("%#v", this.ExpireBefore)+",\n")
	s = append(s, "OrganizationID: "+fmt.Sprintf("%#v", this.OrganizationID)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
type UsersClient interface {
	...
	// Find out when we can delete data (e.g. everything before 3 months ago)
	GetDataExpiry(ctx context.Context, in *DataExpiryRequest, opts ...grpc.CallOption) (*DataExpiryResponse, error)
}
...
func (c *usersClient) RequireTeamMemberPermissionTo(ctx context.Context, in *RequireTeamMemberPermissionToRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc.Invoke(ctx, "/users.Users/RequireTeamMemberPermissionTo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) RequireOrgMemberPermissionTo(ctx context.Context, in *RequireOrgMemberPermissionToRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := grpc.Invoke(ctx, "/users.Users/RequireOrgMemberPermissionTo", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) GetDataExpiry(ctx context.Context, in *DataExpiryRequest, opts ...grpc.CallOption) (*DataExpiryResponse, error) {
	out := new(DataExpiryResponse)
	err := grpc.Invoke(ctx, "/users.Users/GetDataExpiry", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UsersServer interface {
	...
	// Find out when we can delete data (e.g. everything before 3 months ago)
	GetDataExpiry(context.Context, *DataExpiryRequest) (*DataExpiryResponse, error)
}
...
func _Users_GetDataExpiry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataExpiryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServer).GetDataExpiry(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/users.Users/GetDataExpiry",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServer).GetDataExpiry(ctx, req.(*DataExpiryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Users_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetDataExpiry",
			Handler:    _Users_GetDataExpiry_Handler,
		},
	},
...
func (m *RequireTeamMemberPermissionToRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TeamID != nil {
		nn47, err := m.TeamID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn47
...
func (m *RequireTeamMemberPermissionToRequest_TeamInternalID) MarshalTo(dAtA []byte) (int, error) {
	...
	i += copy(dAtA[i:], m.TeamInternalID)
	return i, nil
}
...
func (m *RequireOrgMemberPermissionToRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OrgID != nil {
		nn48, err := m.OrgID.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn48
...
func (m *RequireOrgMemberPermissionToRequest_OrgInternalID) MarshalTo(dAtA []byte) (int, error) {
	...
	i += copy(dAtA[i:], m.OrgInternalID)
	return i, nil
}
func (m *DataExpiryRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataExpiryRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.From)))
	n49, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.From, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n49
	dAtA[i] = 0x1a
	i++
	i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(m.To)))
	n50, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.To, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n50
...
func (m *DataExpiryResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DataExpiryResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ExpireBefore != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintUsers(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdTime(*m.ExpireBefore)))
		n51, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(*m.ExpireBefore, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
	...
	if len(m.OrganizationID) > 0 {
		for _, s := range m.OrganizationID {
			dAtA[i] = 0x12
			i++
			l = len(s)
			for l >= 1<<7 {
...
func NewPopulatedDataExpiryRequest(r randyUsers, easy bool) *DataExpiryRequest {
	this := &DataExpiryRequest{}
	this.OrganizationID = string(randStringUsers(r))
...
func NewPopulatedDataExpiryResponse(r randyUsers, easy bool) *DataExpiryResponse {
	this := &DataExpiryResponse{}
	if r.Intn(10) != 0 {
		this.ExpireBefore = github_com_gogo_protobuf_types.NewPopulatedStdTime(r, easy)
	}
	v40 := r.Intn(10)
	this.OrganizationID = make([]string, v40)
	for i := 0; i < v40; i++ {
		this.OrganizationID[i] = string(randStringUsers(r))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func randFieldUsers(dAtA []byte, r randyUsers, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateUsers(dAtA, uint64(v42))
	case 1:
		dAtA = encodeVarintPopulateUsers(dAtA, uint64(key))
...
func (m *DataExpiryRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.OrganizationID)
	if l > 0 {
...
func (m *DataExpiryResponse) Size() (n int) {
	var l int
	_ = l
	if m.ExpireBefore != nil {
		l = github_com_gogo_protobuf_types.SizeOfStdTime(*m.ExpireBefore)
		n += 1 + l + sovUsers(uint64(l))
	}
	if len(m.OrganizationID) > 0 {
		for _, s := range m.OrganizationID {
...
func (this *DataExpiryRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DataExpiryRequest{`,
		`OrganizationID:` + fmt.Sprintf("%v", this.OrganizationID) + `,`,
		`From:` + strings.Replace(strings.Replace(this.From.String(), "Timestamp", "google_protobuf1.Timestamp", 1), `&`, ``, 1) + `,`,
		`To:` + strings.Replace(strings.Replace(this.To.String(), "Timestamp", "google_protobuf1.Timestamp", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *DataExpiryResponse) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&DataExpiryResponse{`,
		`ExpireBefore:` + strings.Replace(fmt.Sprintf("%v", this.ExpireBefore), "Timestamp", "google_protobuf1.Timestamp", 1) + `,`,
		`OrganizationID:` + fmt.Sprintf("%v", this.OrganizationID) + `,`,
		`}`,
	}, "")
	return s
...
func (m *DataExpiryRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DataExpiryRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DataExpiryRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *DataExpiryResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DataExpiryResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DataExpiryResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpireBefore", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ExpireBefore == nil {
				m.ExpireBefore = new(time.Time)
			}
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(m.ExpireBefore, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			m.OrganizationID = append(m.OrganizationID, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipUsers(dAtA[iNdEx:])
...
var fileDescriptorUsers = []byte{
	...
	,
}
