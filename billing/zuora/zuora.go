...
func New(cfg Config, httpClient client.Requester) *Zuora {
	...
	return &Zuora{
		JSONClient: common.NewJSONClient(httpClient, clientRequestCollector),
		cfg:        cfg,
	}
}
...
func (z *Zuora) Do(ctx context.Context, operation string, r *http.Request) (*http.Response, error) {
	r.Header.Set("apiAccessKeyId", z.cfg.Username)
	r.Header.Set("apiSecretAccessKey", z.cfg.Password)
	return z.JSONClient.Do(ctx, operation, r)
}
