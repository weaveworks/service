...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	flag.StringVar(&cfg.URI, "database.uri", "postgres://postgres@prom-db.default.svc.cluster.local/prom?sslmode=disable", "URI where the database can be found (for dev you can use memory://)")
