...
/*
 * THIS WILL BE UNCOMMENTED ONCE WE ARE READY TO RE-CREATE RDS INSTANCES, PROBABLY POST MT
 * (BECAUSE MT REQUIRES ONE LESS DATABASE, AND ACTULLY INTRODUCES DYNAMO ETC)
 *
module "databases" {
